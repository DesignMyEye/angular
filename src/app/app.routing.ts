...
import { TempvcpComponent } from './examples/tempvcp/tempvcp.component';
import { CasavcpComponent } from './examples/casavcp/casavcp.component';

const routes: Routes =[
    { path: 'presentation',         component: PresentationComponent },
    { path: 'components',           component: ComponentsComponent },
    { path: 'examples/tempvcp',              component: TempvcpComponent },
    { path: 'examples/casavcp',              component: CasavcpComponent },
